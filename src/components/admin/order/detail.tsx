...
function Detail() {
  ...
  const dataSource = order?.data.products.map(
    (item: {
          ...
          <td className="whitespace-nowrap  text-gray-700 py-4 ">
            <div className="items-center ">
              <p className="text-xs lg:text-base md:text-xl flex ">
                ...
                <ImagePriview width={10} listImage={image} />
              </p>
            </div>
          </td>
        );
    ...
    <>
      ...
      <table className="table-auto">
        <tbody>
          ...
          <tr>
            <th className="text-left">Gmail: </th>
            <td>{order?.data?.user?.email}</td>
          </tr>
          <tr>
            <th className="text-left">Người mua: </th>
            <td>{handelChangeObject(order?.data.address).name}</td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td>
              {
                arrStatus.find((item) => item.value === order?.data.status)
                  ?.label
              }
            </td>
          </tr>
